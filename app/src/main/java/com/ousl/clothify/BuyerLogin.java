...
public class BuyerLogin extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (databaseHelper.checkBuyerCredentials(username, password)) {
                    Intent intent = new Intent(BuyerLogin.this, Client_dashbord.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(BuyerLogin.this, "Invalid username or password", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void goToRegisterBuyer(View view) {
        Intent intent = new Intent(this, Register_buyer.class);
        startActivity(intent);
    }
